...
def get_info_from_frame(index:int, info_path:str, write_path:str):
    ...
    new_df = pd.DataFrame({'frame_new_index':[], 'frame_old_index':[], 'time_stamp':[], \
    ...
    for i in range(index, len(frame_to_time_df)):
        ...
        row = {'frame_new_index':None, 'frame_old_index':None, 'time_stamp':None, \
        'x_accel':[], 'y_accel':[], 'z_accel':[], 'x_delta_vel': None, 'y_delta_vel': None, 'z_delta_vel': None,'x_delta':[], 'y_delta':[], 'z_delta':[]}
...
if __name__ == '__main__':
    get_info_from_frame(5000, '/home/tau/Desktop/monocular_data/dataset-corridor1_512_16', '/home/tau/Desktop/monocular_data/dataset-corridor1_512_16')